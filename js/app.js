...
/***/ function(module, exports, __webpack_require__) {
	...
	var routes = React.createElement(
	    ...
	    React.createElement(
	        ...
	        React.createElement(Route, { name: "loginorregisterpage", path: "/loginorregisterpage", component: LoginOrRegisterPage }),
	    ...
	    render: function () {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                "center",
	                null,
	                React.createElement("input", { type: "text", className: "form-control", placeholder: "what do you want to learn?", value: value,
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                completed.length > 0 ? React.createElement(
	                    ...
	                    React.createElement(
	                        "button",
	                        { className: "btn btn-warning btn-md", id: "clear-completed",
	    ...
	    render: function () {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                "div",
	                { className: "view" },
	                React.createElement("input", { id: this.props.item.id, className: "toggle", type: "checkbox",
	                    onChange: this.toggleCompleted.bind(this, this.props.item),
	            ...
	            React.createElement("input", { ref: "editField", className: "edit", onKeyDown: this.handleKeyDown, onChange: this.changeItem,
	                onSubmit: this.saveItem, onBlur: this.saveItem, value: this.state.editText })
	        );
	    }
	});
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement("input", { type: "text", className: "form-control", id: "username", placeholder: "Username", ref: "username",
	                        autoFocus: true })
	                ),
	                React.createElement(
	                    "div",
	...
	var Register = React.createClass({
	    ...
	    render: function () {
	        return React.createElement(
	            ...
	            React.createElement(
	                "form",
	                { className: "form", onSubmit: this.register },
	                React.createElement(
	                    "div",
	                    { className: "form-group" },
