...
module.exports = {
    ...
    module: {
        loaders: [
            ...
            {
                test: /\.png(\?v=\d+\.\d+\.\d+)?$/,
                loader: "url?name=images/[name].[ext]&limit=10000&mimetype=image/png"
            },
            {
                test: /\.jp(e)?g(\?v=\d+\.\d+\.\d+)?$/,
                loader: "url?name=images/[name].[ext]&limit=10000&mimetype=image/jpeg"
            },
            {
                test: /\.tiff(\?v=\d+\.\d+\.\d+)?$/,
                loader: "url?name=images/[name].[ext]&limit=10000&mimetype=image/tiff"
            }
        ]
    }
};
