          ...
          <header id="header">
              <div className="row">
                  <div className="col-md-6">
                      <p><i>{this.props.name}'s custom library</i></p>
                      <p>
                  ...
                  {completed.length > 0 ? (
                      <div className="col-md-6 right">
                          <button className="btn btn-warning btn-md" id="clear-completed" onClick={this.clearCompleted}>Remove selected items ({completed.length})
                          </button>
                      </div>
                  ) : null }
              </div>
